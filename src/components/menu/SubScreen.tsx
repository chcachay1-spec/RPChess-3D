...
const SCREEN_INFO: Record<Screen, { title: string; subtitle: string; variant: 'gold' | 'red' | 'blue' }> = {
  ...
  cards: { title: 'Cards', subtitle: 'Mazo de cartas de efecto · 50 cartas · 3 tipos', variant: 'gold' },
  store: { title: 'Store', subtitle: 'Tienda de cosméticos y consumibles', variant: 'gold' },
  profile: { title: 'User Info', subtitle: 'Tu perfil, progresión y estadísticas', variant: 'gold' },
  news: { title: 'Latest News', subtitle: 'Novedades del reino', variant: 'gold' },
  config: { title: 'Configuration', subtitle: 'Ajustes del juego', variant: 'gold' },
  events: { title: 'Current Events', subtitle: 'Eventos activos de temporada', variant: 'gold' },
  pase: { title: 'Pase de Temporada', subtitle: 'Recompensas gratuitas y premium', variant: 'gold' },
  collection: { title: 'Collection', subtitle: 'Tu colección de piezas y skins', variant: 'gold' },
  draft: { title: 'Draft', subtitle: 'Modo draft de ejércitos', variant: 'gold' },
};
